    ...
    useEffect(() => {
        ...
        const fetchStatus = async () => {
            ...
            if (routines.length > 0) {
                ...
                // DB에 저장된 상태 반영 (routine_item_id 컬럼 사용)
        ...
        "
            >
                ...
                <h2 className="text-xl font-bold mb-2 flex items-center justify-between">
                    <span>🎯 {student.name} 학생 점심시간 도전</span>
                    ...
                    <button
                        ...
                        onClick={async () => {
                            ...
                            try {
                                ...
                                if (routines.length > 0) {
                                    ...
                                    const routineInserts = Object.entries(routineStatus).map(
                                        ([rid, completed]) => ({
                                            ...
                                            routine_item_id: rid, // routine_item_id 컬럼 사용 (Break와 달리 여기는 item_id일 수 있음)
                                            completed,
                                            date: today,
                                        })
                                    );
                                ...
                                console.error("점심 루틴 저장 실패:", error);
